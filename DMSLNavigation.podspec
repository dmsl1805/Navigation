...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/dmsl1805/DMSLNavigation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dmsl1805' => 'dmytro.shulzhenko@gen.tech' }
  s.source           = { :git => 'https://github.com/dmsl1805/DMSLNavigation.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'DMSLNavigation' => ['DMSLNavigation/Assets/*.png']
  # }
